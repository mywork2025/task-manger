...
import { Button, Loading, ModalWrapper, SelectList, Textbox } from "./";
import { useGetDepartmentListsQuery } from "../redux/slices/api/departmentApiSlice";
...
const AddUser = ({ open, setOpen, userData }) => {
  ...
  const { data: departments } = useGetDepartmentListsQuery();
      ...
      <ModalWrapper open={open} setOpen={setOpen}>
        <form onSubmit={handleSubmit(handleOnSubmit)} className="">
          ...
          <div className="flex flex-col gap-6 mt-2">
            ...
            <SelectList
              label="Department"
              lists={departments?.map((d) => d.name)}
